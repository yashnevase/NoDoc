...
export const groups = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "text", icon: "text", title: "Text", detail: "Place text on selected pages", needs: "1 PDF", status: "ready" },
      { id: "draw", icon: "draw", title: "Draw", detail: "Freehand pen on selected pages", needs: "Draw strokes", status: "ready" },
      { id: "highlight", icon: "highlight", title: "Highlight", detail: "Mark areas on selected pages", needs: "Draw boxes", status: "ready" },
      { id: "sign", icon: "sign", title: "Sign", detail: "Place an image signature", needs: "1 PDF", status: "ready" },
  ...
  },
  {
    ...
    label: "OCR",
    tools: [
      { id: "scanned_pdf", icon: "scan", title: "Scanned to PDF", detail: "OCR workflow next", needs: "Later", status: "planned" },
      { id: "image_text", icon: "text", title: "Image to Text", detail: "OCR scanned PDF to text", needs: "1 PDF", status: "ready" },
      { id: "searchable", icon: "search", title: "Searchable PDF", detail: "Build OCR text layer", needs: "1 PDF", status: "ready" },
